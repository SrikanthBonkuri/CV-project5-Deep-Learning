...
def ConvertGreekImages(folder):
    ...
    folder = 'C:/Users/srika/PycharmProjects/pythonProject/greek-1/'
...
class NeuralNetwork_FirstLayer(que1.MyNetwork):
    def __init__(self):
...
def load_learnt_network_status(network, learning_rate, momentum):
    ...
    network_state_dict = torch.load('C:/Users/srika/PycharmProjects/pythonProject/network_state_dict_model.pt')
    network.load_state_dict(network_state_dict)

    optimizer_state_dict = torch.load('C:/Users/srika/PycharmProjects/pythonProject/optimizer_state_dict_model.pt')
...
def loadGreekSymbols(folder):
    ...
    folder = 'C:/Users/malya/PycharmProjects/pythonProject/greek-1/'
...
def main(argv):
    ...
    test_loader = torch.utils.data.DataLoader(torchvision.datasets.MNIST('mnist_data', train=False, download=True,      #download remarked False after downloaded once
    transform=torchvision.transforms.Compose([torchvision.transforms.ToTensor(),
    torchvision.transforms.Normalize((0.1307,), (0.3081,))])), batch_size=batch_size_test, shuffle=False)

    showNNFirstDenseLayer = que1.network
    ...
    #ConvertGreekImages('HandWritting/Greek')       #Convert my own Greek handwritting
    GreekSymbolPixel_handwrite, GreekSymbolLabel_handwrite = loadGreekSymbols("HandWritting/Greek/")
    ...
    HandwrittingGreekImages.append(cv.imread("HandWritting/Greek/GreekFormatted/gamma_2_sri.png"))
    HandwrittingGreekImages.append(cv.imread("HandWritting/Greek/GreekFormatted/beta_1_sri.png"))
    HandwrittingGreekImages.append(cv.imread("HandWritting/Greek/GreekFormatted/alpha_1_sri.png"))
